...
function DronePage() {
  return (
    <Container>
         <div className="dronePage__container">
        <div className="dronePage__content">
        ...
        <div className="dronePage__items">
          <Tabs>
            <TabList>
              <Tab>Agricultural Services</Tab>
              <Tab>Aerial Photography and Videography</Tab>
            ...
            <TabPanel>
              <div className="tabPanel__wrapper">
                ...
                <div className="tabPanel__content">
                  <h3 className="title g-text">Aerial Photography and Videography</h3>
                  <p className="paragraph">
                    We represent a number of leading manufacturers of various
                    kinds of laboratory, industrial, filtration, bioprocess and
                    water testing equipment, reagents. We represent a number of
