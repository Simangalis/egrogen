...
import { ControlsAndInstrumentations } from "../../utilis/data-ControlsAndInstrumentation";
import {
  Grid,
  Card,
  CardContent,
...
import "./ServicesControlsAndInstrumentation.css";
import { Link } from "react-router-dom";

export default function ServicesControlsAndInstrumentation() {
  return (
    <Container sx={{ backgroundColor: "#171719", padding: 1, borderRadius: 1 }}>
      ...
      <Grid container spacing={4} className="container__grid">
        {ControlsAndInstrumentations.map((service, index) => (
