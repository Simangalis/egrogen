...
import './RenewableEnergyPage.css'
...
function RenewableEnergyPage() {
  return (
    <Container>
        <div className="renewableEnergyPage__container">
        <div className="renewableEnergyPage__content">
        ...
        <div className="renewableEnergyPage__items">
        <Tabs>
            <TabList>
              <Tab>Solar Energy Services</Tab>
              <Tab>Wind Energy Services</Tab>
              <Tab>Hydropower Services</Tab>
            ...
            <TabPanel>
              <div className="tabPanel__wrapper">
                <div className="tabPanel__content">
                  <h3 className="title g-text">Solar Energy Services</h3>
            ...
            <TabPanel>
              ...
              <div className="tabPanel__content-image">
                ...
                <div className="tabPanel__content">
                  <h3 className="title g-text">Wind Energy Services</h3>
                  <p className="paragraph">
                    We represent a number of leading manufacturers of various
                    kinds of laboratory, industrial, filtration, bioprocess and
                    water testing equipment, reagents. We represent a number of
            ...
            <TabPanel>
              <div className="tabPanel__wrapper">
                <div className="tabPanel__content">
                  <h3 className="title g-text">Hydropower Services</h3>
                  <p className="paragraph">
                    We represent a number of leading manufacturers of various
                    kinds of laboratory, industrial, filtration, bioprocess and
                    water testing equipment, reagents. We represent a number of
